...
This script does not require the PDBcombiner written by Erik Cook.

This script will break if you enter in an invalid residue name and/or number.

This script was written to work with ctFCP1, which has 83 residues (879-961). This script
will need to be rewritten for proteins of different length (particularly roi_position, residueID, 
and residue_index).                                
...
residue_index = np.arange(878, 962, 1)     
pdbTraj.close()
