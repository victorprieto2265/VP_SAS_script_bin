...
construct = 'centfcp1_phospho_charmm_02'
...
structure_name = 'centfcp1'  # I don't think this name matters
...
# define dictionaries
helical_dict = {}  # for storing helicity values
aa_dict = {}  # for storing AA identities, just as an initial check

for residueB in chain.get_list():  # I kept residueB here because of original
    # script and I didn't want to rename everything from B to A or whatever.
    B_res_id = residueB.get_id()[1]  # add 807 to align with ctFCP1 numbering?
...
for directory in directories:
    ...
    # directory[103:105] are values from 00 to 19
    temperature = str(int(directory[104:106]) * 10 + 230)
