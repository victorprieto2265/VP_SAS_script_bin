...
def pre_calculator(nucleus, r):
    ...
    r = r*10e-8   #note: this may be the wrong conversion factor for angstroms to centimeters, but it seems to fit the experimental data better. Not sure why, there may be another error in the calculation.
...
output_file_name = new_path + 'wt_pre_values.txt'
...
for file in filenames:
    ...
    if processed_models == 0:
        ...
        try:
            average_pre = np.add(average_pre, pre_array)
        except:
